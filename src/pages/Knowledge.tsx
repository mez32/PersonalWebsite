		...
		<MainCard>
			...
			<div className='mt-4 md:mx-4'>
				...
				<ul className='text-left text-lg md:text-xl list-disc list-outside ml-6 mb-2'>
					...
					<li>
						Frontend: React, NextJS, Redux Toolkit, Vite, Formik, Jest, React Testing Library, React
					...
					<li>
						<ToolTip text='https://github.com/mez32/Microservices-Ticket-App'>
							<a
								...
								className='hover:text-neutral-100'
							>
								A microservices ticket buying app with Docker, Kubernetes, TypeScript, Express, NATS
								streaming server, Mongo, and NextJS.
							</a>
						</ToolTip>
					</li>
					<li>
