			...
			<MainCard>
				...
				<div className='md:mx-4'>
					<p className='text-left text-lg md:text-xl lg:text-2xl mb-4'>
						...
						work in frontend web development as a Software Engineer at a local start up. At the
						onset of the pandemic I began to teach myself JavaScript and related frameworks as a way
						to grow myself, personally and professionally, for the future and beyond. I have always
						been intrigued in building things and knowing how they work under the hood so I decided
						to take it on in the digital realm.
					</p>
					<p className='text-left text-lg md:text-xl lg:text-2xl mb-4'>
						&emsp; I had a desire to break into this field of tech on my own terms and set my own
						course for success. With the help of friends who are already professionals in this area,
						I was able to become proficient in only a year and a half. From a complete novice to
					...
					<p className='text-left text-lg md:text-xl lg:text-2xl mb-4'>
						&emsp; This site was built entirely by me using TypeScript, Vite, React, and Tailwind
						and is being hosted on Vercel.{' '}
						...
						and can be found on my Contact Me page.
					</p>
				</div>
				<Link to={'/'}>
